...
fun AddEditDetailView(
    ...
    if(id != 0L){
        val wish = viewModel.getAWisById(id).collectAsState(initial = Wish(0L, "",""))
    ...
    if (id != 0L) stringResource(id = R.string.update_wish)
               ...
               // onBackNavClicked =
                {
                    navController.navigateUp() // Correctly perform the navigation action
                },

                modifier = Modifier.padding(top = 10.dp) // Apply modifier for padding
            )
        }
...
//            title =
//        if (id != 0L)
//        stringResource(id = R.string.update_wish) else stringResource(id = R.string.add_wish)
//        ) {
//            navController.navigateUp()
//        }}) {
